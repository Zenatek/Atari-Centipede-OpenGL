							...
							LPARAM	lParam)			// Additional Message Information
{
	switch (uMsg)									// Check For Windows Messages
	{
      ...
      { Data.active=TRUE; }					// Program Is Active
		...
		//	RECT rt;
		//	Data.xc = ship[0].x;
		//	//	Use the "rt" data to stop the rectangle motion
		//	//GetClientRect(hwnd, &rt);     // "usare per fermare il quadrattino"
		//	int id = (TCHAR)wParam;
		//	if (id == 37) {			// <-
		//		if (Data.xc > 10) Data.xc -= 5;
		//		//InvalidateRect(hwnd, NULL, TRUE);
		//	}
		//	if (id == 39) {			// ->
		//		if (Data.xc < rt.right - 10) Data.xc += 5;
		//		//InvalidateRect(hwnd, NULL, TRUE);
		//	}
		//	if (id == 38) {			// UP
		//		if (Data.yc > 10) Data.yc -= 5;
		//		//InvalidateRect(hwnd, NULL, TRUE);
		//	}
		//	else if (id == 40) {			// DOWN
		//		if (Data.yc < rt.bottom - 10) Data.yc += 5;
		//		//InvalidateRect(hwnd, NULL, TRUE);
		//	}
		//	return 0;
		//}
					...
					int			nCmdShow)			// Window Show State
{
  ...
  Data.fullscreen=false;  // removed the boring request...
	...
	if (!CreateGLWindow("Centipede Atari",640,480,16,Data.fullscreen))
	{
